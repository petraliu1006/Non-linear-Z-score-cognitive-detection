...
mxval <- 9 ## maximum value for the outcome
mnval <- 3 ## minimum value for the outcome
...
gamfitSD <- TRUE ## If TRUE, then don't restrict to monotonic and perform regular GAM fit
